...
class BigQueryWarehouse:
    ...
    DATASET_ID = 'buzzwh'
    KEY_PATH = 'C:/Users/ASUS/Documents/Data Engineering/BuzzliveWarehouse/gcp-keys/hashent-410002-1f512c3626a9.json'
...
class GoogleSheetsConn:
    def __init__(self):
        self.gc = gspread.service_account(filename='C:/Users/ASUS/Documents/Data Engineering/BuzzliveWarehouse/gcp-keys/hashent-410002-1f512c3626a9.json')
